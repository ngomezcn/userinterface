...
import salesforce from "../../assets/images/companies/salesforce.jpg";
                ...
                <Card>
                    <CardBody className="border-bottom">
                        <div className="d-flex">
                            <img src={salesforce} alt="" height="50" />
                            <div className="flex-grow-1 ms-3">
                                <h5 className="fw-semibold">Salesforce CRM</h5>
                                <ul className="list-unstyled hstack gap-2 mb-0">
                                    <li>
                                        <i className="bx bx-building-house"></i> <span className="text-muted">Salesforce</span>
                                    </li>
                                    <li>
                    ...
                    <CardBody>
                        ...
                        <p className="text-muted">Unlock the Power of Integration: Our cutting-edge solution seamlessly bridges the gap between SAP Business One (SBO) and Salesforce CRM. Experience a harmonious synergy between your financial and customer relationship management systems like never before. Streamline operations, gain deeper insights, and supercharge your business with this integration. Elevate your efficiency, enhance decision-making, and elevate your customer experience. Discover the future of business integration today</p>
