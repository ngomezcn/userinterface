...
import {
    getModelsLis as onGetModelsLis,
} from "../../slices/models/thunk";
...
function Models() {
    ...
    const hadnleSearch = (ele: any) => {
        ...
        if (search) {
            setJobList(jobs?.filter((data: any) => data.name.toLowerCase()?.includes(search)))
        } else {
            setJobList(jobs)
        }
    }
                            ...
                            <Card>
                                <CardBody className="border-bottom">
                                    <div className="d-flex align-items-center">
                                        <CardTitle tag="h5" className="mb-0 flex-grow-1">Models List</CardTitle>
                                        <div className="flex-shrink-0">
                                            <Link to="#" onClick={() => handleJobClicks()} className="btn btn-primary me-1">Add New Model</Link>
